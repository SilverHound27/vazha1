...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'administrator' or user_member.status == 'creator':
        message.reply_text("ഇവൻ Admin ആണേ.......")
        return ""

    if user_id == bot.id:
        message.reply_text("സ്വന്തം കൊതത്തിൽ അടിക്കാൻ പറയുന്നോ മൈരേ? വേണേൽ പോയി ഒരു Adminനെ പിടിച്ചോണ്ട് വാ")
        return ""
    ...
    message.reply_text("ആഹ്..... വെള്ളം പോയി")
    return "<b>{}:</b>" \
           "\n#PROMOTED" \
           "\n<b>Admin:</b> {}" \
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user_member.status == 'creator':
        message.reply_text("Group ഉണ്ടാക്കിയവനെ തട്ടാൻ പാടില്ലെന്നാണ് ശാസ്ത്രം")
        return ""

    if not user_member.status == 'administrator':
        message.reply_text("ലവൻ Admin അല്ല")
        return ""
